...
var file_Neonize_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x73, 0x2a, 0x41, 0x0a, 0x0e, 0x4e,
	...
	0x41, 0x42, 0x4c, 0x45, 0x10, 0x0a, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x6e, 0x65, 0x6f, 0x6e,
	0x69, 0x7a, 0x65,
}
...
var file_Neonize_proto_msgTypes = make([]protoimpl.MessageInfo, 110)
var file_Neonize_proto_goTypes = []interface{}{
	...
	(*defproto.VerifiedNameCertificate)(nil),                  // 128: defproto.VerifiedNameCertificate
	(*defproto.VerifiedNameCertificate_Details)(nil),          // 129: defproto.VerifiedNameCertificate.Details
	(*defproto.Message)(nil),                                  // 130: defproto.Message
	(*defproto.WebMessageInfo)(nil),                           // 131: defproto.WebMessageInfo
	(*defproto.SyncActionValue)(nil),                          // 132: defproto.SyncActionValue
	(*defproto.HistorySync)(nil),                              // 133: defproto.HistorySync
}
var file_Neonize_proto_depIdxs = []int32{
	...
	128, // 6: neonize.VerifiedName.Certificate:type_name -> defproto.VerifiedNameCertificate
	129, // 7: neonize.VerifiedName.Details:type_name -> defproto.VerifiedNameCertificate.Details
	...
	130, // 40: neonize.BuildPollVoteReturnFunction.PollVote:type_name -> defproto.Message
	...
	130, // 50: neonize.Message.Message:type_name -> defproto.Message
	131, // 51: neonize.Message.SourceWebMsg:type_name -> defproto.WebMessageInfo
	...
	130, // 70: neonize.NewsletterMessage.Message:type_name -> defproto.Message
	...
	132, // 98: neonize.MutationInfo.Value:type_name -> defproto.SyncActionValue
	...
	133, // 109: neonize.HistorySync.Data:type_name -> defproto.HistorySync
