...
class MessageKey(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ID", b"ID", "fromMe", b"fromMe", "participant", b"participant", "remoteJID", b"remoteJID"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ID", b"ID", "fromMe", b"fromMe", "participant", b"participant", "remoteJID", b"remoteJID"]) -> None: ...
...
class Command(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["commandType", b"commandType", "length", b"length", "offset", b"offset", "validationToken", b"validationToken"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["commandType", b"commandType", "length", b"length", "offset", b"offset", "validationToken", b"validationToken"]) -> None: ...
...
class MessageText(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["commands", b"commands", "mentionedJID", b"mentionedJID", "text", b"text"]) -> None: ...
...
class SubProtocol(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["payload", b"payload", "version", b"version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["payload", b"payload", "version", b"version"]) -> None: ...
