...
class MessageTransport(google.protobuf.message.Message):
    ...
    class Payload(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["applicationPayload", b"applicationPayload", "futureProof", b"futureProof"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["applicationPayload", b"applicationPayload", "futureProof", b"futureProof"]) -> None: ...
    ...
    class Protocol(google.protobuf.message.Message):
        ...
        class Ancillary(google.protobuf.message.Message):
            ...
            class BackupDirective(google.protobuf.message.Message):
                ...
                def HasField(self, field_name: typing_extensions.Literal["actionType", b"actionType", "messageID", b"messageID", "supplementalKey", b"supplementalKey"]) -> builtins.bool: ...
                def ClearField(self, field_name: typing_extensions.Literal["actionType", b"actionType", "messageID", b"messageID", "supplementalKey", b"supplementalKey"]) -> None: ...
            ...
            class ICDCParticipantDevices(google.protobuf.message.Message):
                ...
                class ICDCIdentityListDescription(google.protobuf.message.Message):
                    ...
                    def HasField(self, field_name: typing_extensions.Literal["seq", b"seq", "signingDevice", b"signingDevice"]) -> builtins.bool: ...
                    def ClearField(self, field_name: typing_extensions.Literal["seq", b"seq", "signingDevice", b"signingDevice", "unknownDeviceIDs", b"unknownDeviceIDs", "unknownDevices", b"unknownDevices"]) -> None: ...
                ...
                def HasField(self, field_name: typing_extensions.Literal["senderIdentity", b"senderIdentity"]) -> builtins.bool: ...
                def ClearField(self, field_name: typing_extensions.Literal["recipientIdentities", b"recipientIdentities", "recipientUserJIDs", b"recipientUserJIDs", "senderIdentity", b"senderIdentity"]) -> None: ...
            ...
            def HasField(self, field_name: typing_extensions.Literal["backupDirective", b"backupDirective", "deviceListMetadata", b"deviceListMetadata", "icdc", b"icdc", "skdm", b"skdm"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["backupDirective", b"backupDirective", "deviceListMetadata", b"deviceListMetadata", "icdc", b"icdc", "skdm", b"skdm"]) -> None: ...
        ...
        class Integral(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal["DSM", b"DSM", "padding", b"padding"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["DSM", b"DSM", "padding", b"padding"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["payload", b"payload", "protocol", b"protocol"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["payload", b"payload", "protocol", b"protocol"]) -> None: ...
...
class DeviceListMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["recipientKeyHash", b"recipientKeyHash", "recipientTimestamp", b"recipientTimestamp", "senderKeyHash", b"senderKeyHash", "senderTimestamp", b"senderTimestamp"]) -> None: ...
