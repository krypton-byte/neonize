...
class ChatLockSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["hideLockedChats", b"hideLockedChats", "secretCode", b"secretCode"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["hideLockedChats", b"hideLockedChats", "secretCode", b"secretCode"]) -> None: ...
