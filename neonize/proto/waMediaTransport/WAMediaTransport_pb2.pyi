...
class WAMediaTransport(google.protobuf.message.Message):
    ...
    class Ancillary(google.protobuf.message.Message):
        ...
        class Thumbnail(google.protobuf.message.Message):
            ...
            class DownloadableThumbnail(google.protobuf.message.Message):
                ...
                def HasField(self, field_name: typing_extensions.Literal["directPath", b"directPath", "fileEncSHA256", b"fileEncSHA256", "fileSHA256", b"fileSHA256", "mediaKey", b"mediaKey", "mediaKeyTimestamp", b"mediaKeyTimestamp", "objectID", b"objectID", "thumbnailScansSidecar", b"thumbnailScansSidecar"]) -> builtins.bool: ...
                def ClearField(self, field_name: typing_extensions.Literal["directPath", b"directPath", "fileEncSHA256", b"fileEncSHA256", "fileSHA256", b"fileSHA256", "mediaKey", b"mediaKey", "mediaKeyTimestamp", b"mediaKeyTimestamp", "objectID", b"objectID", "thumbnailScanLengths", b"thumbnailScanLengths", "thumbnailScansSidecar", b"thumbnailScansSidecar"]) -> None: ...
            ...
            def HasField(self, field_name: typing_extensions.Literal["JPEGThumbnail", b"JPEGThumbnail", "downloadableThumbnail", b"downloadableThumbnail", "thumbnailHeight", b"thumbnailHeight", "thumbnailWidth", b"thumbnailWidth"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["JPEGThumbnail", b"JPEGThumbnail", "downloadableThumbnail", b"downloadableThumbnail", "thumbnailHeight", b"thumbnailHeight", "thumbnailWidth", b"thumbnailWidth"]) -> None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal["fileLength", b"fileLength", "mimetype", b"mimetype", "objectID", b"objectID", "thumbnail", b"thumbnail"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["fileLength", b"fileLength", "mimetype", b"mimetype", "objectID", b"objectID", "thumbnail", b"thumbnail"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["ancillary", b"ancillary", "integral", b"integral"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ancillary", b"ancillary", "integral", b"integral"]) -> None: ...
...
class ImageTransport(google.protobuf.message.Message):
    ...
    class Ancillary(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["hdType", b"hdType", "height", b"height", "midQualityFileSHA256", b"midQualityFileSHA256", "scansSidecar", b"scansSidecar", "width", b"width"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["hdType", b"hdType", "height", b"height", "midQualityFileSHA256", b"midQualityFileSHA256", "scanLengths", b"scanLengths", "scansSidecar", b"scansSidecar", "width", b"width"]) -> None: ...
    ...
    class Integral(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["transport", b"transport"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["transport", b"transport"]) -> None: ...
...
class VideoTransport(google.protobuf.message.Message):
    ...
    class Ancillary(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["caption", b"caption", "gifAttribution", b"gifAttribution", "gifPlayback", b"gifPlayback", "height", b"height", "seconds", b"seconds", "sidecar", b"sidecar", "width", b"width"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["caption", b"caption", "gifAttribution", b"gifAttribution", "gifPlayback", b"gifPlayback", "height", b"height", "seconds", b"seconds", "sidecar", b"sidecar", "width", b"width"]) -> None: ...
...
class AudioTransport(google.protobuf.message.Message):
    ...
    class Ancillary(google.protobuf.message.Message):
        ...
        class AvatarAudio(google.protobuf.message.Message):
            ...
            class DownloadableAvatarAnimations(google.protobuf.message.Message):
                ...
                def HasField(self, field_name: typing_extensions.Literal["animationsType", b"animationsType", "directPath", b"directPath", "fileEncSHA256", b"fileEncSHA256", "fileSHA256", b"fileSHA256", "mediaKey", b"mediaKey", "mediaKeyTimestamp", b"mediaKeyTimestamp", "objectID", b"objectID"]) -> builtins.bool: ...
                def ClearField(self, field_name: typing_extensions.Literal["animationsType", b"animationsType", "directPath", b"directPath", "fileEncSHA256", b"fileEncSHA256", "fileSHA256", b"fileSHA256", "mediaKey", b"mediaKey", "mediaKeyTimestamp", b"mediaKeyTimestamp", "objectID", b"objectID"]) -> None: ...
            ...
            def HasField(self, field_name: typing_extensions.Literal["poseID", b"poseID"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["avatarAnimations", b"avatarAnimations", "poseID", b"poseID"]) -> None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal["avatarAudio", b"avatarAudio", "seconds", b"seconds"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["avatarAudio", b"avatarAudio", "seconds", b"seconds"]) -> None: ...
    ...
    class Integral(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["audioFormat", b"audioFormat", "transport", b"transport"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["audioFormat", b"audioFormat", "transport", b"transport"]) -> None: ...
...
class DocumentTransport(google.protobuf.message.Message):
    ...
    class Ancillary(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["pageCount", b"pageCount"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["pageCount", b"pageCount"]) -> None: ...
...
class StickerTransport(google.protobuf.message.Message):
    ...
    class Ancillary(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["firstFrameLength", b"firstFrameLength", "firstFrameSidecar", b"firstFrameSidecar", "height", b"height", "isThirdParty", b"isThirdParty", "mustacheText", b"mustacheText", "pageCount", b"pageCount", "receiverFetchID", b"receiverFetchID", "width", b"width"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["firstFrameLength", b"firstFrameLength", "firstFrameSidecar", b"firstFrameSidecar", "height", b"height", "isThirdParty", b"isThirdParty", "mustacheText", b"mustacheText", "pageCount", b"pageCount", "receiverFetchID", b"receiverFetchID", "width", b"width"]) -> None: ...
    ...
    class Integral(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["isAnimated", b"isAnimated", "receiverFetchID", b"receiverFetchID", "transport", b"transport"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["isAnimated", b"isAnimated", "receiverFetchID", b"receiverFetchID", "transport", b"transport"]) -> None: ...
...
class ContactTransport(google.protobuf.message.Message):
    ...
    class Ancillary(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["displayName", b"displayName"]) -> None: ...
    ...
    class Integral(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["contact", b"contact", "downloadableVcard", b"downloadableVcard", "vcard", b"vcard"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["contact", b"contact", "downloadableVcard", b"downloadableVcard", "vcard", b"vcard"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["contact", b"contact"]) -> typing_extensions.Literal["vcard", "downloadableVcard"] | None: ...
