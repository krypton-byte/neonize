...
class BackupMessage(google.protobuf.message.Message):
    ...
    class Metadata(google.protobuf.message.Message):
        ...
        class FrankingMetadata(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal["frankingTag", b"frankingTag", "reportingTag", b"reportingTag"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["frankingTag", b"frankingTag", "reportingTag", b"reportingTag"]) -> None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal["frankingMetadata", b"frankingMetadata", "futureProofBehavior", b"futureProofBehavior", "messageID", b"messageID", "payloadVersion", b"payloadVersion", "senderID", b"senderID", "timestampMS", b"timestampMS"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["frankingMetadata", b"frankingMetadata", "futureProofBehavior", b"futureProofBehavior", "messageID", b"messageID", "payloadVersion", b"payloadVersion", "senderID", b"senderID", "timestampMS", b"timestampMS"]) -> None: ...
