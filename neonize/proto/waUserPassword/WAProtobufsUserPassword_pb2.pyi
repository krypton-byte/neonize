...
class UserPassword(google.protobuf.message.Message):
    ...
    class TransformerArg(google.protobuf.message.Message):
        ...
        class Value(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal["asBlob", b"asBlob", "asUnsignedInteger", b"asUnsignedInteger", "value", b"value"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["asBlob", b"asBlob", "asUnsignedInteger", b"asUnsignedInteger", "value", b"value"]) -> None: ...
            def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["asBlob", "asUnsignedInteger"] | None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["encoding", b"encoding", "transformedData", b"transformedData", "transformer", b"transformer"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["encoding", b"encoding", "transformedData", b"transformedData", "transformer", b"transformer", "transformerArg", b"transformerArg"]) -> None: ...
