...
class MessageApplication(google.protobuf.message.Message):
    ...
    class Metadata(google.protobuf.message.Message):
        ...
        class QuotedMessage(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal["participant", b"participant", "payload", b"payload", "remoteJID", b"remoteJID", "stanzaID", b"stanzaID"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["participant", b"participant", "payload", b"payload", "remoteJID", b"remoteJID", "stanzaID", b"stanzaID"]) -> None: ...
        ...
        class EphemeralSettingMap(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal["chatJID", b"chatJID", "ephemeralSetting", b"ephemeralSetting"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["chatJID", b"chatJID", "ephemeralSetting", b"ephemeralSetting"]) -> None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal["botResponseID", b"botResponseID", "businessMetadata", b"businessMetadata", "chatEphemeralSetting", b"chatEphemeralSetting", "collapsibleID", b"collapsibleID", "ephemeral", b"ephemeral", "ephemeralSettingList", b"ephemeralSettingList", "ephemeralSharedSecret", b"ephemeralSharedSecret", "forwardingScore", b"forwardingScore", "frankingKey", b"frankingKey", "frankingVersion", b"frankingVersion", "groupID", b"groupID", "groupIndex", b"groupIndex", "groupSize", b"groupSize", "isForwarded", b"isForwarded", "quotedMessage", b"quotedMessage", "readonlyMetadataDataclass", b"readonlyMetadataDataclass", "threadType", b"threadType"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["botResponseID", b"botResponseID", "businessMetadata", b"businessMetadata", "chatEphemeralSetting", b"chatEphemeralSetting", "collapsibleID", b"collapsibleID", "ephemeral", b"ephemeral", "ephemeralSettingList", b"ephemeralSettingList", "ephemeralSharedSecret", b"ephemeralSharedSecret", "forwardingScore", b"forwardingScore", "frankingKey", b"frankingKey", "frankingVersion", b"frankingVersion", "groupID", b"groupID", "groupIndex", b"groupIndex", "groupSize", b"groupSize", "isForwarded", b"isForwarded", "quotedMessage", b"quotedMessage", "readonlyMetadataDataclass", b"readonlyMetadataDataclass", "threadType", b"threadType"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["ephemeral", b"ephemeral"]) -> typing_extensions.Literal["chatEphemeralSetting", "ephemeralSettingList", "ephemeralSharedSecret"] | None: ...
    ...
    class Payload(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["applicationData", b"applicationData", "content", b"content", "coreContent", b"coreContent", "signal", b"signal", "subProtocol", b"subProtocol"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["applicationData", b"applicationData", "content", b"content", "coreContent", b"coreContent", "signal", b"signal", "subProtocol", b"subProtocol"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["content", b"content"]) -> typing_extensions.Literal["coreContent", "signal", "applicationData", "subProtocol"] | None: ...
    ...
    class SubProtocolPayload(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["armadillo", b"armadillo", "businessMessage", b"businessMessage", "consumerMessage", b"consumerMessage", "futureProof", b"futureProof", "multiDevice", b"multiDevice", "paymentMessage", b"paymentMessage", "subProtocol", b"subProtocol", "voip", b"voip"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["armadillo", b"armadillo", "businessMessage", b"businessMessage", "consumerMessage", b"consumerMessage", "futureProof", b"futureProof", "multiDevice", b"multiDevice", "paymentMessage", b"paymentMessage", "subProtocol", b"subProtocol", "voip", b"voip"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["subProtocol", b"subProtocol"]) -> typing_extensions.Literal["consumerMessage", "businessMessage", "paymentMessage", "multiDevice", "voip", "armadillo"] | None: ...
    ...
    class EphemeralSetting(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["ephemeralExpiration", b"ephemeralExpiration", "ephemeralSettingTimestamp", b"ephemeralSettingTimestamp", "isEphemeralSettingReset", b"isEphemeralSettingReset"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["ephemeralExpiration", b"ephemeralExpiration", "ephemeralSettingTimestamp", b"ephemeralSettingTimestamp", "isEphemeralSettingReset", b"isEphemeralSettingReset"]) -> None: ...
