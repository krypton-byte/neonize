...
class ConsumerApplication(google.protobuf.message.Message):
    ...
    class Metadata(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["specialTextSize", b"specialTextSize"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["specialTextSize", b"specialTextSize"]) -> None: ...
    ...
    class ApplicationData(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["applicationContent", b"applicationContent", "revoke", b"revoke"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["applicationContent", b"applicationContent", "revoke", b"revoke"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["applicationContent", b"applicationContent"]) -> typing_extensions.Literal["revoke"] | None: ...
    ...
    class Content(google.protobuf.message.Message):
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["content", b"content"]) -> typing_extensions.Literal["messageText", "imageMessage", "contactMessage", "locationMessage", "extendedTextMessage", "statusTextMessage", "documentMessage", "audioMessage", "videoMessage", "contactsArrayMessage", "liveLocationMessage", "stickerMessage", "groupInviteMessage", "viewOnceMessage", "reactionMessage", "pollCreationMessage", "pollUpdateMessage", "editMessage"] | None: ...
    ...
    class EditMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["key", b"key", "message", b"message", "timestampMS", b"timestampMS"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key", b"key", "message", b"message", "timestampMS", b"timestampMS"]) -> None: ...
    ...
    class PollAddOptionMessage(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["pollOption", b"pollOption"]) -> None: ...
    ...
    class PollVoteMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["senderTimestampMS", b"senderTimestampMS"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["selectedOptions", b"selectedOptions", "senderTimestampMS", b"senderTimestampMS"]) -> None: ...
    ...
    class PollUpdateMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["addOption", b"addOption", "pollCreationMessageKey", b"pollCreationMessageKey", "vote", b"vote"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["addOption", b"addOption", "pollCreationMessageKey", b"pollCreationMessageKey", "vote", b"vote"]) -> None: ...
    ...
    class PollCreationMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["encKey", b"encKey", "name", b"name", "selectableOptionsCount", b"selectableOptionsCount"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["encKey", b"encKey", "name", b"name", "options", b"options", "selectableOptionsCount", b"selectableOptionsCount"]) -> None: ...
    ...
    class ReactionMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["groupingKey", b"groupingKey", "key", b"key", "reactionMetadataDataclassData", b"reactionMetadataDataclassData", "senderTimestampMS", b"senderTimestampMS", "style", b"style", "text", b"text"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["groupingKey", b"groupingKey", "key", b"key", "reactionMetadataDataclassData", b"reactionMetadataDataclassData", "senderTimestampMS", b"senderTimestampMS", "style", b"style", "text", b"text"]) -> None: ...
    ...
    class ViewOnceMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["imageMessage", b"imageMessage", "videoMessage", b"videoMessage", "viewOnceContent", b"viewOnceContent"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["imageMessage", b"imageMessage", "videoMessage", b"videoMessage", "viewOnceContent", b"viewOnceContent"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["viewOnceContent", b"viewOnceContent"]) -> typing_extensions.Literal["imageMessage", "videoMessage"] | None: ...
    ...
    class GroupInviteMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["JPEGThumbnail", b"JPEGThumbnail", "caption", b"caption", "groupJID", b"groupJID", "groupName", b"groupName", "inviteCode", b"inviteCode", "inviteExpiration", b"inviteExpiration"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["JPEGThumbnail", b"JPEGThumbnail", "caption", b"caption", "groupJID", b"groupJID", "groupName", b"groupName", "inviteCode", b"inviteCode", "inviteExpiration", b"inviteExpiration"]) -> None: ...
    ...
    class LiveLocationMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["accuracyInMeters", b"accuracyInMeters", "caption", b"caption", "degreesClockwiseFromMagneticNorth", b"degreesClockwiseFromMagneticNorth", "location", b"location", "sequenceNumber", b"sequenceNumber", "speedInMps", b"speedInMps", "timeOffset", b"timeOffset"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["accuracyInMeters", b"accuracyInMeters", "caption", b"caption", "degreesClockwiseFromMagneticNorth", b"degreesClockwiseFromMagneticNorth", "location", b"location", "sequenceNumber", b"sequenceNumber", "speedInMps", b"speedInMps", "timeOffset", b"timeOffset"]) -> None: ...
    ...
    class ContactsArrayMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["displayName", b"displayName"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["contacts", b"contacts", "displayName", b"displayName"]) -> None: ...
    ...
    class ContactMessage(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["contact", b"contact"]) -> None: ...
    ...
    class StatusTextMesage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["backgroundArgb", b"backgroundArgb", "font", b"font", "text", b"text", "textArgb", b"textArgb"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["backgroundArgb", b"backgroundArgb", "font", b"font", "text", b"text", "textArgb", b"textArgb"]) -> None: ...
    ...
    class ExtendedTextMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["canonicalURL", b"canonicalURL", "description", b"description", "matchedText", b"matchedText", "previewType", b"previewType", "text", b"text", "thumbnail", b"thumbnail", "title", b"title"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["canonicalURL", b"canonicalURL", "description", b"description", "matchedText", b"matchedText", "previewType", b"previewType", "text", b"text", "thumbnail", b"thumbnail", "title", b"title"]) -> None: ...
    ...
    class LocationMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["address", b"address", "location", b"location"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["address", b"address", "location", b"location"]) -> None: ...
    ...
    class StickerMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["sticker", b"sticker"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["sticker", b"sticker"]) -> None: ...
    ...
    class DocumentMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["document", b"document", "fileName", b"fileName"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["document", b"document", "fileName", b"fileName"]) -> None: ...
    ...
    class VideoMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["caption", b"caption", "video", b"video"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["caption", b"caption", "video", b"video"]) -> None: ...
    ...
    class AudioMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["PTT", b"PTT", "audio", b"audio"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["PTT", b"PTT", "audio", b"audio"]) -> None: ...
    ...
    class ImageMessage(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["caption", b"caption", "image", b"image"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["caption", b"caption", "image", b"image"]) -> None: ...
